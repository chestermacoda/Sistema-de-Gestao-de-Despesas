<div class="container-flui px-2">
    <div class="row my-2 justify-content-between nav-top">
        <div class="col-sm-6 col-md-6 nav-top1">
            <p>Inicio <i class="fa-solid fa-angle-right fs-6 fw-2"></i> Ano</p>
        </div>
        <div class="col-sm-6 col-md-6 bg-muted text-end nav-top2">
            <button class="btn btn-primary rounded-0" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fa-regular fa-add"></i> Categoria</button>
        </div>
    </div>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form action="<?= BASE_URL ?>Secretaria/RegistarFuncionario" autocomplete="off">
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 col-md-12 mb-2">
                            ...
                            <input type="number" name="ano" id="" class="form-control form-control-sm" placeholder="Digite o Ano" >
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-sm-12 col-md-12 mb-2">
